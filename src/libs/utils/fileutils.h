...
FEEM_UTILS_EXPORT QDebug operator<<(QDebug dbg, const Utils::FileName &c);
...
FEEM_UTILS_EXPORT QTextStream &operator<<(QTextStream &s, const FileName &fn);

using FileNameList = QList<FileName>;

class FEEM_UTILS_EXPORT FileUtils {
public:
...
template <>
FEEM_UTILS_EXPORT void withNtfsPermissions(const std::function<void()> &task);
...
class FEEM_UTILS_EXPORT FileReader
{
...
class FEEM_UTILS_EXPORT FileSaverBase
{
    Q_DECLARE_TR_FUNCTIONS(Utils::FileUtils) // sic!
public:
    FileSaverBase();
...
class FEEM_UTILS_EXPORT FileSaver : public FileSaverBase
{
    Q_DECLARE_TR_FUNCTIONS(Utils::FileUtils) // sic!
public:
...
class FEEM_UTILS_EXPORT TempFileSaver : public FileSaverBase
{
    Q_DECLARE_TR_FUNCTIONS(Utils::FileUtils) // sic!
public:
...
QT_BEGIN_NAMESPACE
FEEM_UTILS_EXPORT uint qHash(const Utils::FileName &a);
QT_END_NAMESPACE
