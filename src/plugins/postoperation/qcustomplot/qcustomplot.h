...
/*!
  ...
  It provides QMetaObject-based reflection of its enums and flags via \a Postoperation::staticMetaObject.
*/
//#ifndef Q_MOC_RUN
...
/*! \internal
  ...
  \see getMarginValue
*/
inline void setMarginValue(QMargins &margins, Postoperation::MarginSide side, int value)
{
  switch (side)
  {
    case Postoperation::msLeft: margins.setLeft(value); break;
    case Postoperation::msRight: margins.setRight(value); break;
    case Postoperation::msTop: margins.setTop(value); break;
    case Postoperation::msBottom: margins.setBottom(value); break;
    case Postoperation::msAll: margins = QMargins(value, value, value, value); break;
    default: break;
  }
}
...
/*! \internal
  ...
  Returns the value of the specified \a side of \a margins. If \a side is \ref Postoperation::msNone or
  \ref Postoperation::msAll, returns 0.
  
  \see setMarginValue
*/
inline int getMarginValue(const QMargins &margins, Postoperation::MarginSide side)
{
  switch (side)
  {
    case Postoperation::msLeft: return margins.left();
    case Postoperation::msRight: return margins.right();
    case Postoperation::msTop: return margins.top();
    case Postoperation::msBottom: return margins.bottom();
    default: break;
  }
  return 0;
}
...
extern const QMetaObject staticMetaObject; // in moc-run we create a static meta object for QCP "fake" object. This line is the link to it via Postoperation::staticMetaObject in normal operation as namespace
...
protected:
  ...
  virtual Postoperation::Interaction selectionCategory() const;
  ...
  void applyAntialiasingHint(QCPPainter *painter, bool localAntialiased, Postoperation::AntialiasedElement overrideElement) const;
...
public:
  ...
  void simplify();
  void enforceType(Postoperation::SelectionType type);
...
public:
  ...
  // non-virtual methods:
  QList<QCPLayoutElement*> elements(Postoperation::MarginSide side) const { return mChildren.value(side); }
  bool isEmpty() const;
  void clear();
...
protected:
  // non-property members:
  QCustomPlot *mParentPlot;
  QHash<Postoperation::MarginSide, QList<QCPLayoutElement*> > mChildren;
  
  // introduced virtual methods:
  virtual int commonMargin(Postoperation::MarginSide side) const;
  
  // non-virtual methods:
  void addChild(Postoperation::MarginSide side, QCPLayoutElement *element);
  void removeChild(Postoperation::MarginSide side, QCPLayoutElement *element);
...
public:
  ...
  */
  ...
  Postoperation::MarginSides autoMargins() const { return mAutoMargins; }
  QSize minimumSize() const { return mMinimumSize; }
  QSize maximumSize() const { return mMaximumSize; }
  SizeConstraintRect sizeConstraintRect() const { return mSizeConstraintRect; }
  QCPMarginGroup *marginGroup(Postoperation::MarginSide side) const { return mMarginGroups.value(side, (QCPMarginGroup*)0); }
  QHash<Postoperation::MarginSide, QCPMarginGroup*> marginGroups() const { return mMarginGroups; }
  
  // setters:
  void setOuterRect(const QRect &rect);
  void setMargins(const QMargins &margins);
  void setMinimumMargins(const QMargins &margins);
  void setAutoMargins(Postoperation::MarginSides sides);
  void setMinimumSize(const QSize &size);
  void setMinimumSize(int width, int height);
  void setMaximumSize(const QSize &size);
  void setMaximumSize(int width, int height);
  void setSizeConstraintRect(SizeConstraintRect constraintRect);
  void setMarginGroup(Postoperation::MarginSides sides, QCPMarginGroup *group);
...
protected:
  ...
  Postoperation::MarginSides mAutoMargins;
  QHash<Postoperation::MarginSide, QCPMarginGroup*> mMarginGroups;
  
  // introduced virtual methods:
  virtual int calculateAutoMargin(Postoperation::MarginSide side);
...
public:
  ...
  */
  ...
  static AxisType marginSideToAxisType(Postoperation::MarginSide side);
...
protected:
  ...
  Postoperation::AntialiasedElements mAADragBackup, mNotAADragBackup;
  ...
  virtual void applyDefaultAntialiasingHint(QCPPainter *painter) const Q_DECL_OVERRIDE;
  virtual void draw(QCPPainter *painter) Q_DECL_OVERRIDE;
  virtual Postoperation::Interaction selectionCategory() const Q_DECL_OVERRIDE;
  // events:
...
public:
  ...
  QCPRange keyRange(bool &foundRange, Postoperation::SignDomain signDomain=Postoperation::sdBoth);
  QCPRange valueRange(bool &foundRange, Postoperation::SignDomain signDomain=Postoperation::sdBoth, const QCPRange &inKeyRange=QCPRange());
...
*/
template <class DataType>
QCPRange QCPDataContainer<DataType>::keyRange(bool &foundRange, Postoperation::SignDomain signDomain)
{
  if (isEmpty())
  {
    foundRange = false;
  ...
  if (signDomain == Postoperation::sdBoth) // range may be anywhere
  {
  ...
  } else if (signDomain == Postoperation::sdNegative) // range may only be in the negative sign domain
  {
    while (it != itEnd)
    {
      if (!qIsNaN(it->mainValue()))
  ...
  } else if (signDomain == Postoperation::sdPositive) // range may only be in the positive sign domain
  {
    while (it != itEnd)
    {
      if (!qIsNaN(it->mainValue()))
...
*/
template <class DataType>
QCPRange QCPDataContainer<DataType>::valueRange(bool &foundRange, Postoperation::SignDomain signDomain, const QCPRange &inKeyRange)
{
  if (isEmpty())
  {
    foundRange = false;
...
class QCP_LIB_DECL QCPAbstractPlottable : public QCPLayerable
{
  ...
  Q_PROPERTY(Postoperation::SelectionType selectable READ selectable WRITE setSelectable NOTIFY selectableChanged)
...
public:
  ...
  Postoperation::SelectionType selectable() const { return mSelectable; }
  ...
  Q_SLOT void setSelectable(Postoperation::SelectionType selectable);
  ...
  virtual QCPRange getKeyRange(bool &foundRange, Postoperation::SignDomain inSignDomain=Postoperation::sdBoth) const = 0;
  virtual QCPRange getValueRange(bool &foundRange, Postoperation::SignDomain inSignDomain=Postoperation::sdBoth, const QCPRange &inKeyRange=QCPRange()) const = 0;
...
signals:
  ...
  void selectableChanged(Postoperation::SelectionType selectable);
...
protected:
  ...
  Postoperation::SelectionType mSelectable;
...
public:
  ...
  */
  enum RefreshPriority { rpImmediateRefresh ///< Replots immediately and repaints the widget immediately by calling QWidget::repaint() after the replot
                         ...
                         ,rpRefreshHint     ///< Whether to use immediate or queued refresh depends on whether the plotting hint \ref Postoperation::phImmediateRefresh is set, see \ref setPlottingHints.
  ...
  Postoperation::AntialiasedElements antialiasedElements() const { return mAntialiasedElements; }
  Postoperation::AntialiasedElements notAntialiasedElements() const { return mNotAntialiasedElements; }
  bool autoAddPlottableToLegend() const { return mAutoAddPlottableToLegend; }
  const Postoperation::Interactions interactions() const { return mInteractions; }
  int selectionTolerance() const { return mSelectionTolerance; }
  bool noAntialiasingOnDrag() const { return mNoAntialiasingOnDrag; }
  Postoperation::PlottingHints plottingHints() const { return mPlottingHints; }
  Qt::KeyboardModifier multiSelectModifier() const { return mMultiSelectModifier; }
  Postoperation::SelectionRectMode selectionRectMode() const { return mSelectionRectMode; }
  ...
  void setAntialiasedElements(const Postoperation::AntialiasedElements &antialiasedElements);
  void setAntialiasedElement(Postoperation::AntialiasedElement antialiasedElement, bool enabled=true);
  void setNotAntialiasedElements(const Postoperation::AntialiasedElements &notAntialiasedElements);
  void setNotAntialiasedElement(Postoperation::AntialiasedElement notAntialiasedElement, bool enabled=true);
  void setAutoAddPlottableToLegend(bool on);
  void setInteractions(const Postoperation::Interactions &interactions);
  void setInteraction(const Postoperation::Interaction &interaction, bool enabled=true);
  void setSelectionTolerance(int pixels);
  void setNoAntialiasingOnDrag(bool enabled);
  void setPlottingHints(const Postoperation::PlottingHints &hints);
  void setPlottingHint(Postoperation::PlottingHint hint, bool enabled=true);
  void setMultiSelectModifier(Qt::KeyboardModifier modifier);
  void setSelectionRectMode(Postoperation::SelectionRectMode mode);
  ...
  bool savePdf(const QString &fileName, int width=0, int height=0, Postoperation::ExportPen exportPen=Postoperation::epAllowCosmetic, const QString &pdfCreator=QString(), const QString &pdfTitle=QString());
  bool savePng(const QString &fileName, int width=0, int height=0, double scale=1.0, int quality=-1, int resolution=96, Postoperation::ResolutionUnit resolutionUnit=Postoperation::ruDotsPerInch);
  bool saveJpg(const QString &fileName, int width=0, int height=0, double scale=1.0, int quality=-1, int resolution=96, Postoperation::ResolutionUnit resolutionUnit=Postoperation::ruDotsPerInch);
  bool saveBmp(const QString &fileName, int width=0, int height=0, double scale=1.0, int resolution=96, Postoperation::ResolutionUnit resolutionUnit=Postoperation::ruDotsPerInch);
  bool saveRastered(const QString &fileName, int width, int height, double scale, const char *format, int quality=-1, int resolution=96, Postoperation::ResolutionUnit resolutionUnit=Postoperation::ruDotsPerInch);
...
protected:
  ...
  Postoperation::AntialiasedElements mAntialiasedElements, mNotAntialiasedElements;
  Postoperation::Interactions mInteractions;
  ...
  Postoperation::PlottingHints mPlottingHints;
  Qt::KeyboardModifier mMultiSelectModifier;
  Postoperation::SelectionRectMode mSelectionRectMode;
  ...
  Postoperation::AntialiasedElements mOpenGlAntialiasedElementsBackup;
...
/*! \fn virtual QCPDataSelection QCPPlottableInterface1D::selectTestRect(const QRectF &rect, bool onlySelectable) const = 0;
  ...
  selectable (i.e. if \ref QCPAbstractPlottable::setSelectable is \ref Postoperation::stNone).
...
QCPDataSelection QCPAbstractPlottable1D<DataType>::selectTestRect(const QRectF &rect, bool onlySelectable) const
{
  ...
  if ((onlySelectable && mSelectable == Postoperation::stNone) || mDataContainer->isEmpty())
    return result;
...
void QCPAbstractPlottable1D<DataType>::getDataSegments(QList<QCPDataRange> &selectedSegments, QList<QCPDataRange> &unselectedSegments) const
{
  ...
  if (mSelectable == Postoperation::stWhole) // stWhole selection type draws the entire plottable with selected style if mSelection isn't empty
  {
    if (selected())
...
void QCPAbstractPlottable1D<DataType>::drawPolyline(QCPPainter *painter, const QVector<QPointF> &lineData) const
{
  ...
  if (mParentPlot->plottingHints().testFlag(Postoperation::phFastPolylines) &&
...
protected:
  ...
  virtual void applyDefaultAntialiasingHint(QCPPainter *painter) const Q_DECL_OVERRIDE;
  virtual void draw(QCPPainter *painter) Q_DECL_OVERRIDE;
  virtual int calculateAutoMargin(Postoperation::MarginSide side) Q_DECL_OVERRIDE;
...
public:
  ...
  */
  ...
  // reimplemented virtual methods:
  virtual double selectTest(const QPointF &pos, bool onlySelectable, QVariant *details=0) const Q_DECL_OVERRIDE;
  virtual QCPRange getKeyRange(bool &foundRange, Postoperation::SignDomain inSignDomain=Postoperation::sdBoth) const Q_DECL_OVERRIDE;
  virtual QCPRange getValueRange(bool &foundRange, Postoperation::SignDomain inSignDomain=Postoperation::sdBoth, const QCPRange &inKeyRange=QCPRange()) const Q_DECL_OVERRIDE;
...
} // end of namespace Postoperation
Q_DECLARE_METATYPE(Postoperation::ExportPen)
Q_DECLARE_METATYPE(Postoperation::ResolutionUnit)
Q_DECLARE_METATYPE(Postoperation::SignDomain)
Q_DECLARE_METATYPE(Postoperation::MarginSide)
Q_DECLARE_METATYPE(Postoperation::AntialiasedElement)
Q_DECLARE_METATYPE(Postoperation::PlottingHint)
Q_DECLARE_METATYPE(Postoperation::Interaction)
Q_DECLARE_METATYPE(Postoperation::SelectionRectMode)
Q_DECLARE_METATYPE(Postoperation::SelectionType)

Q_DECLARE_TYPEINFO(Postoperation::QCPVector2D, Q_MOVABLE_TYPE);

Q_DECLARE_METATYPE(Postoperation::QCPPainter::PainterMode)

Q_DECLARE_METATYPE(Postoperation::QCPLayer::LayerMode)

Q_DECLARE_METATYPE(Postoperation::QCPDataSelection)

Q_DECLARE_METATYPE(Postoperation::QCPLayoutElement::UpdatePhase)

Q_DECLARE_METATYPE(Postoperation::QCPLayoutGrid::FillOrder)

Q_DECLARE_METATYPE(Postoperation::QCPLayoutInset::InsetPlacement)

Q_DECLARE_TYPEINFO(Postoperation::QCPLineEnding, Q_MOVABLE_TYPE);
Q_DECLARE_METATYPE(Postoperation::QCPLineEnding::EndingStyle)

Q_DECLARE_METATYPE(Postoperation::QCPAxisTicker::TickStepStrategy)
//Q_DECLARE_METATYPE(Postoperation::QSharedPointer<Postoperation::QCPAxisTicker>)

Q_DECLARE_METATYPE(Postoperation::QCPAxisTickerTime::TimeUnit)

Q_DECLARE_METATYPE(Postoperation::QCPAxisTickerFixed::ScaleStrategy)

Q_DECLARE_METATYPE(Postoperation::QCPAxisTickerPi::FractionStyle)

Q_DECLARE_METATYPE(Postoperation::QCPAxis::AxisType)
Q_DECLARE_METATYPE(Postoperation::QCPAxis::LabelSide)
Q_DECLARE_METATYPE(Postoperation::QCPAxis::ScaleType)
Q_DECLARE_METATYPE(Postoperation::QCPAxis::SelectablePart)

Q_DECLARE_TYPEINFO(Postoperation::QCPScatterStyle, Q_MOVABLE_TYPE);
Q_DECLARE_METATYPE(Postoperation::QCPScatterStyle::ScatterProperty)
Q_DECLARE_METATYPE(Postoperation::QCPScatterStyle::ScatterShape)

Q_DECLARE_METATYPE(Postoperation::QCPSelectionDecorator*)

Q_DECLARE_METATYPE(Postoperation::QCPItemPosition::PositionType)

Q_DECLARE_METATYPE(Postoperation::QCustomPlot::LayerInsertMode)
Q_DECLARE_METATYPE(Postoperation::QCustomPlot::RefreshPriority)

Q_DECLARE_METATYPE(Postoperation::QCPColorGradient::ColorInterpolation)
Q_DECLARE_METATYPE(Postoperation::QCPColorGradient::GradientPreset)

Q_DECLARE_METATYPE(Postoperation::QCPSelectionDecoratorBracket::BracketStyle)

Q_DECLARE_METATYPE(Postoperation::QCPLegend::SelectablePart)

Q_DECLARE_METATYPE(Postoperation::QCPGraph::LineStyle)

Q_DECLARE_METATYPE(Postoperation::QCPCurve::LineStyle)

Q_DECLARE_METATYPE(Postoperation::QCPBarsGroup::SpacingType)

Q_DECLARE_METATYPE(Postoperation::QCPBars::WidthType)

Q_DECLARE_METATYPE(Postoperation::QCPFinancial::ChartStyle)

Q_DECLARE_METATYPE(Postoperation::QCPItemTracer::TracerStyle)

Q_DECLARE_METATYPE(Postoperation::QCPItemBracket::BracketStyle)

Q_DECLARE_TYPEINFO(Postoperation::QCPRange, Q_MOVABLE_TYPE);
Q_DECLARE_TYPEINFO(Postoperation::QCPDataRange, Q_MOVABLE_TYPE);
Q_DECLARE_TYPEINFO(Postoperation::QCPGraphData, Q_PRIMITIVE_TYPE);
Q_DECLARE_TYPEINFO(Postoperation::QCPCurveData, Q_PRIMITIVE_TYPE);
Q_DECLARE_TYPEINFO(Postoperation::QCPBarsData, Q_PRIMITIVE_TYPE);
Q_DECLARE_TYPEINFO(Postoperation::QCPStatisticalBoxData, Q_MOVABLE_TYPE);
Q_DECLARE_TYPEINFO(Postoperation::QCPFinancialData, Q_PRIMITIVE_TYPE);
Q_DECLARE_TYPEINFO(Postoperation::QCPErrorBarsData, Q_PRIMITIVE_TYPE);
