...
//    Theme *theme = Utils::creatorTheme();
    if (isActive) {
        if (forText) {
            pal.setColor(QPalette::Background, QColor("#555759"));
            pal.setColor(QPalette::Foreground, QColor("#555759"));
            pal.setColor(QPalette::WindowText, QColor("#f8f8f8"));
        } else {
            pal.setColor(QPalette::Background, QColor("#555759"));
            pal.setColor(QPalette::Foreground, QColor("#555759"));
        }
        ...
        if (isCursorInside) {
            if (forText) {
                pal.setColor(QPalette::Background, QColor("#e8e8e8"));
                pal.setColor(QPalette::Foreground, QColor("#e8e8e8"));
                pal.setColor(QPalette::WindowText, QColor("#000000"));
            } else {
                pal.setColor(QPalette::Background, QColor("#e8e8e8"));
                pal.setColor(QPalette::Foreground, QColor("#727476"));
            }
        } else {
            if (forText) {
                pal.setColor(QPalette::Background, QColor("#555759"));
                pal.setColor(QPalette::Foreground, QColor("#f8f8f8"));
                pal.setColor(QPalette::WindowText, QColor("#000000"));
            } else {
                pal.setColor(QPalette::Background, QColor("#f8f8f8"));
                pal.setColor(QPalette::Foreground, QColor("#727476"));
            }
        }
    }
